...
set base_name=`echo $micrograph_stack | sed  's/.mrcs//g'` 

echo $base_name

if ( -e "$micrograph_stack:r_SAs_norm.mrcs" ) then
	echo 'Output exists'
	exit
endif
...
echo 'making micrograph SAs stack for' $micrograph_stack

newstack $micrograph_stack:r_MT*_SA_stack_norm.st $micrograph_stack:r_SAs.mrcs
...
echo 'normalising in relion'

relion_preprocess --norm true --bg_radius $background_box_radius --operate_on $micrograph_stack:r_SAs.mrcs --operate_out $micrograph_stack:r_SAs_norm.mrcs

rm -rf $micrograph_stack:r_SAs.mrcs
rm -rf $micrograph_stack:r_SA_norm.star
...
rm -rf $micrograph_stack:r_MT*_SA_stack_norm.st
