...
WARNING: Still cannot deal with full 3.1 star file. Need to trim the data_optics part first
HB 2020/02/20
...
def get_particles(starfile):
    ...
    trakIDX = MetaDataLabels.index('rlnHelicalTrackLengthAngst')
...
if args.ang:
    ...
    mgphIDX = MetaDataLabels.index('rlnMicrographName')
    tubeIDX = MetaDataLabels.index('rlnHelicalTubeID')
    xshIDX = MetaDataLabels.index('rlnOriginXAngst') 
    yshIDX = MetaDataLabels.index('rlnOriginYAngst') 
